...
public class YongsanCourse3 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yongsan_course3);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.534049, 127.008047)).title("펜케익 오리지널 스토리").snippet("식당"); // 장소의 위치 알려주기
        place2 = new MarkerOptions().position(new LatLng(37.535188, 127.009665)).title("언더프레셔").snippet("카페");
        place3 = new MarkerOptions().position(new LatLng(37.534176, 127.010199)).title("로얄맨션").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.534450, 127.009014); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_yongsancourse3_popup_window);
