...
public class KwangjinJungnangCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kwangjin_jungnang_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(37.54848,127.08088)).title("서울어린이대공원").snippet("테마파크");
        place2 = new MarkerOptions().position(new LatLng(37.545695,127.085237)).title("서북면옥").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(37.535701,127.095693)).title("강변CGV").snippet("영화관");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.540857, 127.087451); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_kwangjinjungnangcourse1_popop_window);
