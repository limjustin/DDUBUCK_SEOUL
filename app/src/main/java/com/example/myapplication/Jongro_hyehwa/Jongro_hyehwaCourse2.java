...
public class Jongro_hyehwaCourse2 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jongro_hyehwa_course2);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(  37.579767 , 126.982051  )).title("오리지널 시카고피자").snippet("피자");
        place2 = new MarkerOptions().position(new LatLng(  37.583163 , 126.982072  )).title("골목숲").snippet("카페");
        place3 = new MarkerOptions().position(new LatLng(  37.580145 , 126.982369  )).title("올마이티 치즈버거").snippet("햄버거");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng( 37.581025, 126.982164 ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_jongro_hyehwacourse2_popup_window);
