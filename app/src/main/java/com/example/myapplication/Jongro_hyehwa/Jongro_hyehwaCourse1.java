...
public class Jongro_hyehwaCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jongro_hyehwa_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(  37.579887 ,  127.003896 )).title("디마떼오").snippet("식당");
        place2 = new MarkerOptions().position(new LatLng(  37.581916 ,  127.0017   )).title("학림 다방").snippet("술집");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(  37.580693 , 127.003099  );
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_jongro_hyehwacourse1_popup_window);
