...
public class Jongro_hyehwaCourse5 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jongro_hyehwa_course5);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.582445,	126.986025)).title("북촌전통 공예체험장").snippet("공예품 체험");
        place2 = new MarkerOptions().position(new LatLng(37.581684,	126.985346)).title("이가신가").snippet("한식 음식점");
        place3 = new MarkerOptions().position(new LatLng(37.58242,	126.983669)).title("북촌한옥마을").snippet("관광명소");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(  37.582183 , 126.985013 ); // 줌인 할 수 있는 장소 만들기 // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_jongro_hyehwacourse5_popup_window);
