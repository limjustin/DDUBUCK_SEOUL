...
public class GangbukSeongbuk_NowonDobongCourse4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gangbuk_seongbuk__nowon_dobong_course4);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(37.689562, 127.048162)).title("서울창포원").snippet("수목원"); // 장소의 위치 알려주기
        place2 = new MarkerOptions().position(new LatLng(37.688486,127.042073)).title("짬뽕키친").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(37.68798,127.046539)).title("산과산사이커피로드").snippet("카페");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.688899, 127.043799); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_gangbukseongbuk__nowondobongcourse4_popup_window);
