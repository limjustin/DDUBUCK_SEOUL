...
public class GangbukSeongbuk_NowonDobongCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gangbuk_seongbuk__nowon_dobong_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.621644, 127.040539)).title("북서울꿈의숲").snippet("테마공원");
        place2 = new MarkerOptions().position(new LatLng(37.621635,	127.040603)).title("북서울꿈의숲 라포레스타").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.621644, 127.040579); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_gangbukseongbuk__nowondobongcourse1_popup_window);
