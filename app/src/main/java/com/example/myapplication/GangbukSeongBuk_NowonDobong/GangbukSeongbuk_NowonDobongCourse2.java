...
public class GangbukSeongbuk_NowonDobongCourse2 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gangbuk_seongbuk__nowon_dobong_course2);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(37.631645, 127.069807)).title("경춘선숲길").snippet("관광명소");
        place2 = new MarkerOptions().position(new LatLng(37.631078,127.074677)).title("핏짜굽는언니").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.630589, 127.072122); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_gangbukseongbuk__nowondobongcourse2_popup_window);
