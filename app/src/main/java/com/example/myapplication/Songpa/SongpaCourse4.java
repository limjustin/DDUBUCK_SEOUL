...
public class SongpaCourse4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_songpa_course4);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.5209657,127.116064)).title("올림픽공원").snippet("경기장");
        place2 = new MarkerOptions().position(new LatLng(37.5006336,127.138267)).title("성내천").snippet("관광명소");
        place3 = new MarkerOptions().position(new LatLng(37.4980687,127.150679)).title("마천시장").snippet("전통시장");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.512117, 127.134330); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_songpacourse4_popup_window);
