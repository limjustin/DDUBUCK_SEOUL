...
public class SongpaCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_songpa_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.5019147,127.110663)).title("힐링 레스토랑").snippet("식당");
        place2 = new MarkerOptions().position(new LatLng(37.5013579,127.108672)).title("파티트리").snippet("사진관");
        place3 = new MarkerOptions().position(new LatLng(37.5068383,127.106146)).title("라딧프로젝트").snippet("카페");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.5033703, 127.1084937); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_songpacourse1_popup_window);
