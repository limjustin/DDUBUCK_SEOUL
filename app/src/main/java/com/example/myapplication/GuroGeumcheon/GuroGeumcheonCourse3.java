...
public class GuroGeumcheonCourse3 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guro_geumcheon_course3);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.4802708,126.890076)).title("월래순교자관").snippet("식당");
        place2 = new MarkerOptions().position(new LatLng(37.4781686,126.887072)).title("마리오아울렛").snippet("복합쇼핑몰");
        place3 = new MarkerOptions().position(new LatLng(37.4775668, 126.889062)).title("현대아울렛").snippet("복합쇼핑몰");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.47866873, 126.8887367); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_gurogeumcheoncourse3_popup_window);
