...
public class MapoguCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapogu_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(37.556524,126.924931)).title("손오공 마라탕").snippet("식당");
        place2 = new MarkerOptions().position(new LatLng(37.549764,126.919401)).title("미스터리룸").snippet("방탈출");
        place3 = new MarkerOptions().position(new LatLng(37.562999,126.925357)).title("시가지").snippet("술집");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.556429, 126.923229); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_mapogucourse1_popup_window);
