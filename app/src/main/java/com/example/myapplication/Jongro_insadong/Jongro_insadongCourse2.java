...
public class Jongro_insadongCourse2 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jongro_insadong_course2);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(  37.570595 ,  127.005686 )).title("진옥화 할매원조 닭한마리").snippet("식당");
        place2 = new MarkerOptions().position(new LatLng(  37.571658 ,  127.024563 )).title("청계천").snippet("관광명소");
        place3 = new MarkerOptions().position(new LatLng(  37.570044 ,  126.991035 )).title("삼해집").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(  37.570839 , 126.998889  ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_jongro_insadongcourse2_popup_window);
