...
public class Jongro_insadongCourse5 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jongro_insadong_course5);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(  37.574853 , 126.994175 )).title("종묘").snippet("관광지");
        place2 = new MarkerOptions().position(new LatLng(  37.572727 , 126.999972  )).title("한옥집").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(  37.574164 , 126.989459  )).title("뜰안").snippet("카페");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(  37.573914 , 126.994535  ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_jongro_insadongcourse5_popup_window);
