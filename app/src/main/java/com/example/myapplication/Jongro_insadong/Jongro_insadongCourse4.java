...
public class Jongro_insadongCourse4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jongro_insadong_course4);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(  37.57166, 126.986832)).title("두리한지공방").snippet("공예품체험");
        place2 = new MarkerOptions().position(new LatLng(  37.570044 , 126.991035  )).title("삼해집 서남").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(  37.569101 , 126.986227  )).title("코너비(카페)").snippet("카페");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng( 37.570268  , 126.988031 ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_jongro_insadongcourse4_popup_window);
