...
public class Jongro_insadongCourse3 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jongro_insadong_course3);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng( 37.582305  ,  126.964379 )).title("수성동 계곡").snippet("관광명소");
        place2 = new MarkerOptions().position(new LatLng(  37.582772 ,  126.97037 )).title("애월식당").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(  37.580988 ,  126.968459 )).title("효자카페").snippet("카페");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(  37.582021 , 126.967736  ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_jongro_insadongcourse3_popup_window);
