...
public class KangsuYangchunCourse4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kangsu_yangchun_course4);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(  37.642741 , 126.678319  )).title("라베치네").snippet("식당");
        place2 = new MarkerOptions().position(new LatLng(  37.64134 ,  126.679328 )).title("노이").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(  37.641358 , 126.679791  )).title("팜트리").snippet("카페");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(  37.641813 , 126.679145  ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_kangsuyangchuncourse4_popup_window);
