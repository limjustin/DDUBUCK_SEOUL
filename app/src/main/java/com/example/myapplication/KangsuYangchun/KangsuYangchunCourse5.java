...
public class KangsuYangchunCourse5 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kangsu_yangchun_course5);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.568066,	126.850977)).title("허준 박물관").snippet("박물관");
        place2 = new MarkerOptions().position(new LatLng(37.567786,	126.852905)).title("구암 공원").snippet("공원");
        place3 = new MarkerOptions().position(new LatLng(37.562881,	126.852992)).title("더족발 가양점").snippet("맛집");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(  37.566101 , 126.851142  ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_kangsuyangchuncourse5_popup_window);
