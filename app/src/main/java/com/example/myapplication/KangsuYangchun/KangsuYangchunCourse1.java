...
public class KangsuYangchunCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kangsu_yangchun_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(  37.53039 ,  126.847213  )).title("쉴만한 물가").snippet("카페");
        place2 = new MarkerOptions().position(new LatLng(  37.530639 , 126.84796  )).title("썬 파스타").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(  37.532876 , 126.847339  )).title("와플에숍").snippet("카페");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(  37.531301 ,  126.847504 ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_kangsuyangchuncourse1_popup_window);
