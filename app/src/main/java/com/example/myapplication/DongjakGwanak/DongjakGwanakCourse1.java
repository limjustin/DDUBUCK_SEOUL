...
public class DongjakGwanakCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dongjak_gwanak_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.4830565,126.926342)).title("신원시장").snippet("전통시장");
        place2 = new MarkerOptions().position(new LatLng(37.4832562,126.928739)).title("순대타운").snippet("식당골목");
        place3 = new MarkerOptions().position(new LatLng(37.4837245,126.928343)).title("더 진국").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.48334573, 126.927808); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_dongjakgwanakcourse1_popup_window);
