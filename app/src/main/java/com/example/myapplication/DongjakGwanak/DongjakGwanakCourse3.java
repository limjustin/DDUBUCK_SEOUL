...
public class DongjakGwanakCourse3 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dongjak_gwanak_course3);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(37.4821837,126.928254)).title("도림천").snippet("관광지");
        place2 = new MarkerOptions().position(new LatLng(37.4929996,126.920464)).title("보라매공원").snippet("근린공원");
        place3 = new MarkerOptions().position(new LatLng(37.4829307,126.913804)).title("알쌈 쭈꾸미").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng( 37.487297, 126.920741 ); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_dongjakgwanakcourse3_popup_window);
