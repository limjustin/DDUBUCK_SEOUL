...
public class JungguCourse4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_junggu_course4);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.556778,126.975253)).title("서울로7017").snippet("관광명소,고가도로"); // 장소의 위치 알려주기
        place2 = new MarkerOptions().position(new LatLng(37.562068,126.974856)).title("보나베띠").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(37.560887,126.969372)).title("서소문역사공원").snippet("근린공원");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.559911,126.973160); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_junggucourse4_popup_window);
