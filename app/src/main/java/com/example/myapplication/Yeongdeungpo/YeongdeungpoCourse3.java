...
public class YeongdeungpoCourse3 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yeongdeungpo_course3);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.525573,126.925465)).title("IFC Mall").snippet("복합쇼핑몰");
        place2 = new MarkerOptions().position(new LatLng(37.517342,126.903873)).title("타임스퀘어").snippet("복합쇼핑몰");
        place3 = new MarkerOptions().position(new LatLng(37.519963,126.908263)).title("영등포재래시장").snippet("전통시장");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.525150, 126.918392); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_yeongdeungpocourse3_popop_window);
