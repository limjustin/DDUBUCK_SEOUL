...
public class YeongdeungpoCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yeongdeungpo_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.5178436,126.881944)).title("영롱이인라인마당").snippet("인라인스케이트");
        place2 = new MarkerOptions().position(new LatLng(37.542843,126.886718)).title("영롱이갈대구장").snippet("축구장");
        place3 = new MarkerOptions().position(new LatLng(37.550218,126.882115)).title("양화인공폭포").snippet("관광지");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.535755, 126.882699); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_yeongdeungpocourse1_popop_window);
