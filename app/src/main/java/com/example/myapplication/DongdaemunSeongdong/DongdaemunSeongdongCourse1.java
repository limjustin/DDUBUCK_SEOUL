...
public class DongdaemunSeongdongCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dongdaemun_seongdong_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(37.590995,127.043524)).title("세종대왕기념관").snippet("기념관,생가");
        place2 = new MarkerOptions().position(new LatLng(37.588675,127.043608)).title("영휘원").snippet("문화재,능");
        place3 = new MarkerOptions().position(new LatLng(37.591215,127.037948)).title("더테이블").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.590017, 127.039502); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_dongdaemunseongdongcourse1_popup_window);
