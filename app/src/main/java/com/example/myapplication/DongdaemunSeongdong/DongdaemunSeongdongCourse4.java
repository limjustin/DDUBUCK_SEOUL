...
public class DongdaemunSeongdongCourse4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dongdaemun_seongdong_course4);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.541056, 127.019261)).title("매봉산공원").snippet("근린공원"); // 장소의 위치 알려주기
        place2 = new MarkerOptions().position(new LatLng(37.541655, 127.017792)).title("옥수해물찜칼국수").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.540992, 127.018169); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_dongdaemunseongdongcourse4_popup_window);
