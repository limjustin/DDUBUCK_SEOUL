...
public class EnpyungSudaemunCourse3 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enpyung_sudaemun_course3);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);


        place1 = new MarkerOptions().position(new LatLng(37.581082,126.942888)).title("안산 산책길").snippet("관광지");
        place2 = new MarkerOptions().position(new LatLng(37.576749,126.937838)).title("서대문 자연사 박물관").snippet("박물관");
        place3 = new MarkerOptions().position(new LatLng(37.57269,126.93513)).title("우동 카덴").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.577677, 126.939102); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_eunpyungsudaemuncourse3_popup_window);
