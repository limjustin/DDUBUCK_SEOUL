...
public class EnpyungSudaemunCourse1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enpyung_sudaemun_course1);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(37.574311,126.956066)).title("서대문 형무소").snippet("박물관");
        place2 = new MarkerOptions().position(new LatLng(37.566634,126.964846)).title("한옥집").snippet("식당");
        place3 = new MarkerOptions().position(new LatLng(37.570624,126.961876)).title("카페떡마을").snippet("카페");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng(37.570523, 126.960929); // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_eunpyungsudaemuncourse1_popup_window);
