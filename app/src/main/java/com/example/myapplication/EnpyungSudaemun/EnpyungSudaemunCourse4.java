...
public class EnpyungSudaemunCourse4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enpyung_sudaemun_course4);
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFrag);
        mapFragment.getMapAsync(this);

        place1 = new MarkerOptions().position(new LatLng(  37.569116 ,  126.931101 )).title("작은 나폴리").snippet("식당");
        place2 = new MarkerOptions().position(new LatLng(  37.568832 ,  126.931182 )).title("마호가니").snippet("카페");
        place3 = new MarkerOptions().position(new LatLng(  37.568494 ,  126.93055 )).title("목란").snippet("식당");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng zoom = new LatLng( 37.568813  , 126.930944  );  // 줌인 할 수 있는 장소 만들기
    ...
    public void ShowPopup(View view) {
        TextView X_button;
        myDialog.setContentView(R.layout.activity_eunpyungsudaemuncourse4_popup_window);
